    ...
    def create_publicdataportal_traditionalday_dag(dag_config_param : dict, dag_id : str, schedule_interval : timedelta, start_date : datetime, default_args : dict) -> DAG:
        ...
        def publicdataportal_traditionalday_dag() -> DAG:
            ...
            def open_api_request():
                ...
                cur_request_url_obj : PublicDataPortalTraditionalDayUrl = None
                if prev_task_instance_or_None is None:
                    cur_request_url = dag_config_param['uri']
                    assert cur_request_url is not None
                    cur_request_url_obj : PublicDataPortalTraditionalDayUrl = UrlObjectFactory.createPublicDataPortalTraditionalDayUrl(cur_request_url)
                ...
                src_nm : str = dag_config_param['src_nm']
                assert src_nm is not None
                tb_nm : str = dag_config_param['tb_nm']
                assert tb_nm is not None
            ...
            def open_api_csv_save():
                ...
                assert dag_config_param['dir_path'] is not None
