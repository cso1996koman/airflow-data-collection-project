    ...
    def create_publicdataportal_anniversary_dag(dag_config_param : dict, dag_id : str, schedule_interval : timedelta, start_date : datetime, default_args : dict) -> DAG:
        ...
        def publicdataportal_anniversary_dag() -> DAG:
            ...
            def open_api_csv_save():
                ...
                cur_dag_run_open_api_request_task_instance_xcom_dto : OpenApiXcomDto = OpenApiXcomDto.from_dict(cur_dag_run_open_api_request_task_instance.xcom_pull(key=f"{dag_id}_{cur_dag_run_open_api_request_task_instance.task_id}_{cur_dag_run_open_api_request_task_instance.run_id}"))
                ...
                cur_dag_run_open_api_request_task_instance_xcom_dict['csv_file_path'] = csv_file_path
            ...
            def open_api_hdfs_save():
                ...
                cur_dag_run_open_api_csv_save_task_instance_xcom_dto : OpenApiXcomDto = OpenApiXcomDto.from_dict(prev_task_instance.xcom_pull(key=f"{dag_id}_{prev_task_instance.task_id}_{prev_task_instance.run_id}"))
                assert cur_dag_run_open_api_csv_save_task_instance_xcom_dto is not None
